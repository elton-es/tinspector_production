...
class TestPlan:
    def __init__(self, window):
        ...
        self.view_name_label['text'] = 'Test Cycle View'
        ...
        self.tv_data.column(1, width=300, anchor='c')
        self.tv_data.column(2, width=475, anchor='c')
        self.tv_data.column(3, width=200, anchor='c')
        self.tv_data.column(4, width=200, anchor='c')
        self.tv_data.column(5, width=550, anchor='c')
        self.tv_data.heading(1, text='Name')
        self.tv_data.heading(2, text='Description')
        self.tv_data.heading(3, text='Status')
        self.tv_data.heading(4, text='Validation')
        self.tv_data.heading(5, text='Comment')
        self.tv_data.insert('', 'end', iid=1, values=['-', '-', '-', '-', '-'], tags=('init',))
        ...
        self.tv_data.tag_configure('fetched', font=('Helvetica', 10, 'bold'), foreground='#363636', background='#E8E8E8')
        self.tv_data.tag_configure('ok', font=('Helvetica', 10, 'bold'), foreground='#50C878', background='#E8E8E8')
        self.tv_data.tag_configure('not_ok', font=('Helvetica', 10, 'bold'), foreground='#880808', background='#F3E8EA')
