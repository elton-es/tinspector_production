...
class CRs:
    def __init__(self, window):
        ...
        self.crs_params_frame['background'] = '#783176'
        ...
        self.view_name_label['text'] = 'Issues View'
        ...
        self.tv_failed_tcs_number['text'] = 'Number of failed Test Executions:'
        ...
        self.tv_labels['text'] = 'Type in the issue\'s labels'
        ...
        self.tv_data.heading(2, text='Issue Status')
    ...
    def set_number_of_failed_test_executions(self, number):
